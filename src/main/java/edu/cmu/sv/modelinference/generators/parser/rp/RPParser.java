 ...
 */
package edu.cmu.sv.modelinference.generators.parser.rp;
 ...
 */
public class RPParser implements LogParser<RPEntry> {

  @Override
  public RPEntry parse(String raw) throws ParserException {
